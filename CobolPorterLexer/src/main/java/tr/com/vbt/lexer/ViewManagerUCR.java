...
public class ViewManagerUCR implements ViewManager{

	private static Map<String, String> viewSynonymMap = new HashMap<>();

	final static Logger logger = LoggerFactory.getLogger(ViewManagerUCR.class);
	
	private static ViewManagerUCR instance;
	
	public static ViewManagerUCR getInstance() {
		if (instance == null) {
			instance = new ViewManagerUCR();
		}
		return instance;
	}
