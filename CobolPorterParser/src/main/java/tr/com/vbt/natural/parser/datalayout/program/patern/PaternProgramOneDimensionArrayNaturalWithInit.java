 ...
 **/
public class PaternProgramOneDimensionArrayNaturalWithInit extends AbstractDataTypePattern{

	final static Logger logger = LoggerFactory.getLogger(PaternProgramOneDimensionArrayNaturalWithInit.class);
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		AbstractPattern asp =new PaternProgramOneDimensionArrayNaturalWithInit();
	...
	public PaternProgramOneDimensionArrayNaturalWithInit() {
		super();
		...
		//1
		astArrayStart=new SayiToken<Integer>();
		astArrayStart.setSourceFieldName("arrayStart");
		patternTokenList.add(astArrayStart);
		
		// :
		astDoubleDot=new KarakterToken(':', 0,0,0);
		patternTokenList.add(astDoubleDot);
		...
		//Sayi
		astInitValue=new GenelTipToken<>();
