 ...
 */
public class PaternAssign extends AbstractPatternFromXToYWithCarriageReturn{

	final static Logger logger = LoggerFactory.getLogger(PaternAssign.class);
	/**
	 * @param args
	 */
	...
	public PaternAssign() {
		...
		becomesEqualTo=new OzelKelimeToken("ASSIGN", 0, 0, 0);
		...
		AbstractToken ender=new OzelKelimeToken(ReservedNaturalKeywords.END_ASSIGN,0,0,0);
	...
	public AbstractCommand getmatchedCommand(List<AbstractToken> tokenListesi, int offset) {
		...
		while(tokenListIterator.hasNext()){
			...
			if(currentTokenForMatch.getTip().equals(TokenTipi.OzelKelime)&&currentTokenForMatch.getDeger().equals("END_ASSIGN")){
						logger.info(" MATCHED"+currentTokenForMatch.getDeger());
