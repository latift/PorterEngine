 ...
 *
 */
public class PaternMoveLeftJustified extends AbstractPattern{

	final static Logger logger = LoggerFactory.getLogger(PaternMoveLeftJustified.class);
	...
	public PaternMoveLeftJustified() {
		super();
		
		//MOVE
		AbstractToken<String> astKeyword=new OzelKelimeToken<String>("MOVE_LEFT_JUSTIFIED", 0, 0, 0);
