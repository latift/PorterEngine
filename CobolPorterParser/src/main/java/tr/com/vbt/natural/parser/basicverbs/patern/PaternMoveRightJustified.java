 ...
 *
 */
public class PaternMoveRightJustified extends AbstractPattern{

	final static Logger logger = LoggerFactory.getLogger(PaternMoveRightJustified.class);
	...
	public PaternMoveRightJustified() {
		super();
		
		//MOVE
		AbstractToken<String> astKeyword=new OzelKelimeToken<String>("MOVE_RIGHT_JUSTIFIED", 0, 0, 0);
