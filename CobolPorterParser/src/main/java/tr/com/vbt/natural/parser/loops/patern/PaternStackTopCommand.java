 ...
 *
 */
public class PaternStackTopCommand extends AbstractPattern {
	...
	public PaternStackTopCommand() {
		super();

		// ESCAPE_TOP
		AbstractToken astKeyword = new OzelKelimeToken(ReservedNaturalKeywords.STACK_TOP_COMMAND, 0, 0, 0);
