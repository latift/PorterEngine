 ...
 **/
public class PaternProgramOneDimensionFloatArrayNatural2 extends AbstractDataTypePattern{

	final static Logger logger = LoggerFactory.getLogger(PaternProgramOneDimensionFloatArrayNatural2.class);
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		AbstractPattern asp =new PaternProgramOneDimensionFloatArrayNatural2();

	}

	public PaternProgramOneDimensionFloatArrayNatural2() {
		super();
