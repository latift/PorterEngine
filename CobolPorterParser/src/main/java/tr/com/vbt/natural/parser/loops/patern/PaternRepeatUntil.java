 ...
 *
 */
public class PaternRepeatUntil extends AbstractPatternFromXToYWithoutCarriageReturn{
	...
	public PaternRepeatUntil() {
		super();
		
		//IF
		starterToken=new OzelKelimeToken("REPEAT_UNTIL", 0, 0, 0);
	...
	public AbstractCommand createElement(){
		ElementRepeatUntil elementDisplay = new ElementRepeatUntil(ReservedNaturalKeywords.REPEAT_UNTIL,"GENERAL.*.REPEAT_UNTIL");
	...
	public void setTokenToElement(AbstractCommand matchedCommand,
		...
		ElementRepeatUntil matchedCommandAdd=(ElementRepeatUntil) matchedCommand;
