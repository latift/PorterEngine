...
import tr.com.vbt.token.SayiToken;
 ...
 /**S**  
  		1 #DIZI-KLIM(N9.3/1:500)	Local Normal Dizi Tanımı
  		
 **/
public class PaternProgramOneDimensionFloatArrayNatural2WithInit extends AbstractDataTypePattern{

	final static Logger logger = LoggerFactory.getLogger(PaternProgramOneDimensionFloatArrayNatural2WithInit.class);
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		AbstractPattern asp =new PaternProgramOneDimensionFloatArrayNatural2WithInit();

	}

	public PaternProgramOneDimensionFloatArrayNatural2WithInit() {
		super();
