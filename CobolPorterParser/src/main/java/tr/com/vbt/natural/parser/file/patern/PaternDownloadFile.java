package tr.com.vbt.natural.parser.file.patern;
 ...
 *  CLOSE RMFFILE. 
 */
public class PaternDownloadFile extends AbstractPatternFromXToYWithCarriageReturn{
	...
	public PaternDownloadFile() {
		super();
		
		//CLOSE
		AbstractToken starter=new OzelKelimeToken("DOWNLOAD", 0, 0, 0);
		...
		//Ender
		AbstractToken ender=new OzelKelimeToken(ReservedCobolKeywords.END_DOWNLOAD,0,0,0);
	...
	public AbstractCommand createElement(){
		ElementDownloadFile createdElement = new ElementDownloadFile(ReservedCobolKeywords.CLOSE,"PROCEDURE_DIVISION.*.CLOSE_FILE");
	...
	public void setTokenToElement(AbstractCommand matchedCommand,
		...
		ElementDownloadFile matchedCommandAdd=(ElementDownloadFile) matchedCommand;
