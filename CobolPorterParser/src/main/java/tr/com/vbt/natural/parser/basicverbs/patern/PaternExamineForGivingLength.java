 ...
 *
 */
public class PaternExamineForGivingLength extends AbstractPattern{
	...
	public PaternExamineForGivingLength() {
		super();
		...
		//GIVING_INDEX
		AbstractToken astKeyword2=new OzelKelimeToken("GIVING_LENGTH", 0, 0, 0);
