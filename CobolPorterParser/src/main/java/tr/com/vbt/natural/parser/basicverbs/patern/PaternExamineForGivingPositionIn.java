 ...
 *
 */
public class PaternExamineForGivingPositionIn extends AbstractPattern{
	...
	public PaternExamineForGivingPositionIn() {
		super();
		...
		//GIVING_POSITION
		AbstractToken astKeyword2=new OzelKelimeToken("GIVING_POSITION_IN", 0, 0, 0);
