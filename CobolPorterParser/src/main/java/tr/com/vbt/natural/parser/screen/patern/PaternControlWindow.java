...
/**
 ...
 0996   CONTROL WINDOW  
 */
public class PaternControlWindow extends AbstractPattern{

	
	public PaternControlWindow() {
		super();
		
		//SIZE
		AbstractToken astKeyword=new OzelKelimeToken("CONTROL_WINDOW", 0, 0, 0);
		astKeyword.setSourceFieldName("FIRST_COMMAND");
		astKeyword.setTekrarlayabilir("+");
		astKeyword.setSourceFieldName("controlWindow");
	...
	public void setTokenToElement(AbstractCommand matchedCommand,
		...
		}else if(abstractTokenInPattern.getSourceFieldName().equals("controlWindow")){
			
			matchedCommandAdd.setWindowOrScreen("window");
