...
import tr.com.vbt.token.SayiToken;
 ...
 /**S**  
		...
		INIT  Uzunluk:0 Satir No:5 Tipi:OzelKelime Pojo
		<  Uzunluk:1 Satir No:5 Tipi:Karakter Pojo
		0.0  Uzunluk:0 Satir No:5 Tipi:Sayi Pojo
		>  Uzunluk:1 Satir No:5 Tipi:Karakter Pojo
		*/
 
public class PaternProgramDataTypeNaturalWithInit extends AbstractDataTypePattern{

	final static Logger logger = LoggerFactory.getLogger(PaternProgramDataTypeNaturalWithInit.class);
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		AbstractPattern asp =new PaternProgramDataTypeNaturalWithInit();

	}

	public PaternProgramDataTypeNaturalWithInit() {
		super();
...
//		*	N8.5
		...
		//Sayi
		AbstractToken astSource9_1=new SayiToken<>();
	...
	public void setTokenToElement(AbstractCommand matchedCommand,
		...
		super.setSatirNumarasi(matchedCommand,currentTokenForMatch, abstractTokenInPattern);if(abstractTokenInPattern.getSourceFieldName()==null){
			...
			Integer deger= (Integer) currentTokenForMatch.getDeger();
			matchedCommandAdd.setInitialValue(deger.toString());
