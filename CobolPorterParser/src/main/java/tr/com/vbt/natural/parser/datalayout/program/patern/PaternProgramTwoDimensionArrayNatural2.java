 ...
 **/
public class PaternProgramTwoDimensionArrayNatural2 extends AbstractDataTypePattern{

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		AbstractPattern asp =new PaternProgramTwoDimensionArrayNatural2();

	}

	public PaternProgramTwoDimensionArrayNatural2() {
		super();
