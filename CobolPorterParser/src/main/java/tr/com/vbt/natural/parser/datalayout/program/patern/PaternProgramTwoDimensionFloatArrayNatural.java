...
import tr.com.vbt.token.SayiToken;
 ...
 /**S**  
  		1 #DIZI-KLIM(N3.9/1:500,1:60)	  Local Normal Two Dimension Dizi Tanımı
 **/
public class PaternProgramTwoDimensionFloatArrayNatural extends AbstractDataTypePattern{

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		AbstractPattern asp =new PaternProgramTwoDimensionFloatArrayNatural();

	}

	public PaternProgramTwoDimensionFloatArrayNatural() {
		super();
		...
		AbstractToken astSource14=new SayiToken();
		astSource14.setSourceFieldName("lengthAfterDot");
		patternTokenList.add(astSource14);
