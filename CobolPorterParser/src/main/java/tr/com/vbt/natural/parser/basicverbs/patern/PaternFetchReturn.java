...
import tr.com.vbt.natural.parser.basicverbs.ElementFetchReturn;
 ...
 *
 */
public class PaternFetchReturn extends AbstractPattern_XY_KKKK_Z_WithoutCarriageReturn{
	...
	public PaternFetchReturn() {
		super();
		
		//FETCH_RETURN
		this.starterToken=new OzelKelimeToken("FETCH_RETURN", 0, 0, 0);
	...
	public AbstractCommand createElement(){
		ElementFetchReturn elementDisplay = new ElementFetchReturn(ReservedNaturalKeywords.FETCH,"GENERAL.*.FETCH_RETURN");
	...
	public void setTokenToElement(AbstractCommand matchedCommand,
		...
		ElementFetchReturn matchedCommandAdd=(ElementFetchReturn) matchedCommand;
