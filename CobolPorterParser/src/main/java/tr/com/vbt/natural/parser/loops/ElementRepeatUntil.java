...
public class ElementRepeatUntil extends AbstractMultipleLinesCommand{
	
	private List<AbstractToken> conditionList=new ArrayList<AbstractToken>();
	
	public ElementRepeatUntil(AbstractToken baseToken,
			List<AbstractToken> tokenListesi, AbstractCommand parent) {
		super("PerformTimes","GENERAL.*.REPEAT_UNTIL");
	}
	
	
	public ElementRepeatUntil(String elementName,String detailedCobolName) {
