...
public class ElementExamineGivingNumber extends AbstractCommand{
	...
	public ElementExamineGivingNumber(String elementName,String detailedCobolName) {
		super(elementName, detailedCobolName);
	}
	
	public ElementExamineGivingNumber(AbstractCommand parent, String elementName,
			String detailedCobolName, List<AbstractCommand> commandListesi) {
		super(parent, elementName, detailedCobolName, commandListesi);
	}
	
	public ElementExamineGivingNumber(String elementName,String detailedCobolName, List<AbstractCommand> commandListesi) {
	...
	public String exportCommands() {
		...
		sb.append(" "+ReservedNaturalKeywords.EXAMINE_GIVING_NUMBER +"=\"");
