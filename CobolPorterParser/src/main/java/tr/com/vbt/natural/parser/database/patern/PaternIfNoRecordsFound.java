 ...
 */
public class PaternIfNoRecordsFound extends AbstractPattern {
	...
	public PaternIfNoRecordsFound() {
		super();

		// FIND
		AbstractToken astKeyword = new OzelKelimeToken("IF_NO_RECORDS_FOUND", 0, 0, 0);
