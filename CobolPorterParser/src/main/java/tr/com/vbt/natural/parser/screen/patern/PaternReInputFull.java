 ...
 *
 */
public class PaternReInputFull extends AbstractPattern{

	final static Logger logger = Logger.getLogger(PaternReInputFull.class);
	...
	public PaternReInputFull() {
		super();
		
		//REINPUT
		this.starterToken=new OzelKelimeToken("REINPUT_FULL", 0, 0, 0);
	...
	public void setTokenToElement(AbstractCommand matchedCommand,
		...
		matchedCommandAdd.getParameters().put("full","true");
	}
