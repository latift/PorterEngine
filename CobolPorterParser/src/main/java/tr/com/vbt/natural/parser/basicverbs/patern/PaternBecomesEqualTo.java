 ...
 *
 */
public class PaternBecomesEqualTo extends AbstractPattern{

	final static Logger logger = LoggerFactory.getLogger(PaternBecomesEqualTo.class);
	...
	AbstractToken becomesEqualTo,copyToToken,midfieldToken,midfieldToken2, copyFromToken, becomesEqualToEnd;
	

	public PaternBecomesEqualTo() {
		super();
		...
		//:
		midfieldToken=new KarakterToken(':', 0,0,0);
