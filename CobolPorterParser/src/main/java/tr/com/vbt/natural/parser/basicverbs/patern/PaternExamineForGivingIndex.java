 ...
 *
 */
public class PaternExamineForGivingIndex extends AbstractPattern{
	...
	public PaternExamineForGivingIndex() {
		super();
		...
		//GIVING_INDEX
		AbstractToken astKeyword2=new OzelKelimeToken("GIVING_INDEX", 0, 0, 0);
