 ...
 *
 */
public class ElementFindOneWith extends AbstractMultipleLinesCommand{
	...
	public ElementFindOneWith(AbstractToken baseToken,
			List<AbstractToken> tokenListesi, AbstractCommand parent) {
		super("Find","DATABASE.*.FIND_WITH");
	}

	public ElementFindOneWith(String elementName,String detailedCobolName) {
	...
	public String exportContents() {
		...
		sb.append(" "+ReservedNaturalKeywords.FIND_ONE_WITH +"=\"");
