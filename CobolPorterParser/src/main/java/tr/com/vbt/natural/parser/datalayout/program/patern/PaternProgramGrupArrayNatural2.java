 ...
 *
 */
public class PaternProgramGrupArrayNatural2 extends AbstractDataTypePattern{

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		AbstractPattern asp =new PaternProgramGrupArrayNatural2();

	}

	public PaternProgramGrupArrayNatural2() {
		super();
