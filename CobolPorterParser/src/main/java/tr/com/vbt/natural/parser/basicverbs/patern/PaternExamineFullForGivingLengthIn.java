...
import tr.com.vbt.natural.parser.basicverbs.ElementExamineFullGivingLengthIn;
...
/**
 *1430   EXAMINE FULL MAP.PASNUM2 FOR ' ' GIVING LENGTH IN PASLEN1
 *
 */
public class PaternExamineFullForGivingLengthIn extends AbstractPattern{
	...
	public PaternExamineFullForGivingLengthIn() {
		super();
		
		
		
		//EXAMINE
		AbstractToken astKeyword=new OzelKelimeToken("EXAMINE_FULL", 0, 0, 0);
		...
		//GIVING_INDEX
		AbstractToken astKeyword2=new OzelKelimeToken("GIVING_LENGTH_IN", 0, 0, 0);
	...
	public AbstractCommand createElement(){
		ElementExamineFullGivingLengthIn createdElement = new ElementExamineFullGivingLengthIn(ReservedNaturalKeywords.EXAMINE_FULL_GIVING_LENGTH_IN,"GENERAL.EXAMINE_FULL_GIVING_LENGTH_IN");
	...
	public void setTokenToElement(AbstractCommand matchedCommand,
		...
		ElementExamineFullGivingLengthIn matchedCommandIndex=(ElementExamineFullGivingLengthIn) matchedCommand;
