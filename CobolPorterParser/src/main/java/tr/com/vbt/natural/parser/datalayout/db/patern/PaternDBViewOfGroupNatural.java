 ...
 *
 */
public class PaternDBViewOfGroupNatural extends AbstractDataTypePattern{

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		AbstractPattern asp =new PaternDBViewOfGroupNatural();

	}

	public PaternDBViewOfGroupNatural() {
		super();
		...
		//VIEW
		AbstractToken astRedefines=new OzelKelimeToken("VIEW_OF", 0, 0, 0);
