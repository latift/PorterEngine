 ...
 *
 */
public class PaternWriteWithPrintNumberAndNoTitle extends AbstractPatternFromXToYWithoutCarriageReturn{

	final static Logger logger = LoggerFactory.getLogger(PaternWriteWithPrintNumberAndNoTitle.class);
	...
	public PaternWriteWithPrintNumberAndNoTitle() {
		super();
		...
		noTitle=new OzelKelimeToken(ReservedNaturalKeywords.NOTITLE, 0, 0, 0);
		patternTokenList.add(noTitle);
	...
	public AbstractCommand getmatchedCommand(List<AbstractToken> tokenListesi, int offset) {
		...
		currentTokenForMatch=tokenListIterator.next();
		if(!currentTokenForMatch.tokenMatchs(noTitle)){
			return null;
		}
		logger.info(" MATCHED: "+currentTokenForMatch.getDeger());
		matchedCommand.increaseCommandsMatchPoint();
