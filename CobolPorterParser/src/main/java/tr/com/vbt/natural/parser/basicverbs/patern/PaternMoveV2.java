 ...
 *     
	MOVE  Uzunluk:0 Satir No:182 Tipi:OzelKelime
	|     **   T R A N S F E R   R E S.  /  P A R T   S H I  Uzunluk:0 Satir No:182 Tipi:Kelime
	-  Uzunluk:1 Satir No:182 Tipi:Karakter
	 P M E N T   **     |  Uzunluk:0 Satir No:183 Tipi:Kelime
	TO  Uzunluk:0 Satir No:183 Tipi:OzelKelime
	DIYEZ_HDR  Uzunluk:0 Satir No:183 Tipi:Kelime LocalVariable
 *
 */
public class PaternMoveV2 extends AbstractPattern{

	final static Logger logger = Logger.getLogger(PaternMoveV2.class);
	...
	public void setTokenToElement(AbstractCommand matchedCommand,
		...
		super.setSatirNumarasi(matchedCommand,currentTokenForMatch, abstractTokenInPattern);if(abstractTokenInPattern.getSourceFieldName()==null){
			...
			if(matchedCommandAdd.getDataToMove()!=null){
				currentTokenForMatch.setDeger(matchedCommandAdd.getDataToMove().getDeger().toString()+currentTokenForMatch.getDeger().toString());
	...
	public AbstractCommand getmatchedCommand(List<AbstractToken> tokenListesi, int offset) {
		...
		while(tokenListIterator.hasNext()){
			...
			if(currentTokenForMatch.isOzelKelime("TO")){
				break;
			}
			if(currentTokenForMatch.isOzelKelime()){ //TO degilse ve özel kelime ise cık buradan.
				return null;
			}
