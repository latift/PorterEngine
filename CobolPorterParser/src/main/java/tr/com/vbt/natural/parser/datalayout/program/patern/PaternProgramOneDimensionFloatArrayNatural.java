 ...
 **/
public class PaternProgramOneDimensionFloatArrayNatural extends AbstractDataTypePattern{

	final static Logger logger = LoggerFactory.getLogger(PaternProgramOneDimensionFloatArrayNatural.class);
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		AbstractPattern asp =new PaternProgramOneDimensionFloatArrayNatural();

	}

	public PaternProgramOneDimensionFloatArrayNatural() {
		super();
