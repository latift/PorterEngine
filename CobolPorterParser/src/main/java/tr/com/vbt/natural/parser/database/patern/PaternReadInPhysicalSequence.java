 ...
 *  
 *  READ IDGIDBS-THESAP IN PHYSICAL SEQUENCE 
 *  

 */
public class PaternReadInPhysicalSequence extends AbstractPatternFromXToYWithoutCarriageReturn {

	final static Logger logger = LoggerFactory.getLogger(PaternReadInPhysicalSequence.class);
	/**
	 * @param args
	 */
	...
	AbstractToken astViewName,astKeywordWith, inPhysicalSequenceToken;

	public PaternReadInPhysicalSequence() {
		super();
		...
		// FIND
		inPhysicalSequenceToken = new OzelKelimeToken("IN_PHYSICAL_SEQUENCE", 0, 0, 0);
		inPhysicalSequenceToken.setSourceFieldName("IN_PHYSICAL_SEQUENCE");
		patternTokenList.add(inPhysicalSequenceToken);
	...
	public AbstractCommand getmatchedCommand(List<AbstractToken> tokenListesi, int offset) {
		...
		if(!currentTokenForMatch.tokenMatchs(inPhysicalSequenceToken)){
			return null;
		}
		setTokenToElement(matchedCommand, currentTokenForMatch,inPhysicalSequenceToken);
		logger.info(" MATCHED: "+currentTokenForMatch.getDeger());
