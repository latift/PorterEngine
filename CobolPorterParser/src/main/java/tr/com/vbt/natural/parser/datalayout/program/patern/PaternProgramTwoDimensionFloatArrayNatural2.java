...
import tr.com.vbt.token.SayiToken;
 ...
 /**S**  
  		1 #DIZI-KLIM(N9.3/500,60)	  Local Normal Two Dimension Dizi Tanımı
 **/
public class PaternProgramTwoDimensionFloatArrayNatural2 extends AbstractDataTypePattern{
	...
	public PaternProgramTwoDimensionFloatArrayNatural2() {
		super();
