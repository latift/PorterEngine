...
/*
 * 000001		05 VAC-AMTFMT                   PIC 9(8)					000001
 * 
 ...
 * 
 */
public class PaternDataTypeLevel_9_Size extends AbstractPattern{

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		AbstractPattern asp =new PaternDataTypeLevel_9_Size();

	}

	public PaternDataTypeLevel_9_Size() {
		super();
		//01
