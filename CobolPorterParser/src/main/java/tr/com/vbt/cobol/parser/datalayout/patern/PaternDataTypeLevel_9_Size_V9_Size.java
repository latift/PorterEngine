...
/*
 * 000001		05 VAC-AMTFMT      OCCURS  30 TIMES            PIC 9(12)V(12)					000001
 * 
...
public class PaternDataTypeLevel_9_Size_V9_Size extends AbstractPattern{

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		AbstractPattern asp =new PaternDataTypeLevel_9_Size_V9_Size();

	}

	public PaternDataTypeLevel_9_Size_V9_Size() {
		super();
		//01
		...
		//	*	12 Mandatory Sayi
		AbstractToken astSource10=new SayiToken<Integer>();
		astSource10.setSourceFieldName("decimalLength");
