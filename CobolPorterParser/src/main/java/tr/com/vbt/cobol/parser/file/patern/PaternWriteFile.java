...
import tr.com.vbt.cobol.parser.file.ElementWriteFile;
 ...
 *
 */
public class PaternWriteFile extends AbstractPattern{
	...
	public PaternWriteFile() {
		super();
		
		//READ
		AbstractToken astKeyword=new OzelKelimeToken("WRITE", 0, 0, 0);
	...
	public AbstractCommand createElement(){
		ElementWriteFile elementDisplay = new ElementWriteFile(ReservedCobolKeywords.WRITE_FILE,"PROCEDURE_DIVISION.*.WRITE_FILE");
	...
	public void setTokenToElement(AbstractCommand matchedCommand,
		...
		ElementWriteFile matchedCommandAdd=(ElementWriteFile) matchedCommand;
