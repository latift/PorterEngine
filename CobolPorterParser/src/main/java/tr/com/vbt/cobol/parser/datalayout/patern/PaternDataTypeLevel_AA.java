...
/*10  VCC-DBID                PIC AAA
 	...
 	000001		05 VAC-AMTFMT                   PIC AAA					000001
 * 
 * X Mandatory Kelime(değer verilmeyecek.)
 * 
 *
 */
public class PaternDataTypeLevel_AA extends AbstractPattern{

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		AbstractPattern asp =new PaternDataTypeLevel_AA();

	}

	public PaternDataTypeLevel_AA() {
		super();
		...
		astSource4.addToShouldHaveList('A');
	...
	public void setTokenToElement(AbstractCommand matchedCommand,
		...
		super.setSatirNumarasi(matchedCommand,currentTokenForMatch, abstractTokenInPattern);if(abstractTokenInPattern.getSourceFieldName()==null){
			...
			matchedCommandAdd.setLength(((String) currentTokenForMatch.getDeger()).length());
