...
public class PaternDataDivision extends AbstractPattern{
	...
	public PaternDataDivision() {
		...
		//DATA DIVISION
		AbstractToken astKeyword=new OzelKelimeToken("DATA_DIVISION", 0, 0, 0);
	...
	public AbstractCommand createElement(){
		ElementDataDivision createdElement = new ElementDataDivision(ReservedCobolKeywords.DATA_DIVISION,"DATA_DIVISION");
