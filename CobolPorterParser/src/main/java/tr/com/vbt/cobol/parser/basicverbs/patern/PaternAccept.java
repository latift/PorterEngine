 ...
 *
 */
public class PaternAccept extends AbstractPatternFromXToYWithoutCarriageReturn{
	...
	public AbstractCommand createElement(){
		ElementIf elementDisplay = new ElementIf(ReservedCobolKeywords.ACCEPT,"GENERAL.*.ACCEPT");
