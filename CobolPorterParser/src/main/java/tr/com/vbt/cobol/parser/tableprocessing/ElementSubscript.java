...
public class ElementSubscript extends AbstractCommand{
	
	private String paragraghName;
	
	public ElementSubscript(AbstractToken baseToken,
			List<AbstractToken> tokenListesi, AbstractCommand parent) {
		super("ElementSubscript","PROCEDURE_DIVISION.*.SUBSCRIPT");
	}
	
	public ElementSubscript(String elementName,String detailedCobolName) {
