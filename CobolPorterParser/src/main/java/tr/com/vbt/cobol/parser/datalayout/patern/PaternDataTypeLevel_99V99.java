...
/*
 * 000001		05 VAC-AMTFMT                   PIC 99V999					000001
 * 
 * 9 Mandatory Sayi(değer verilmeyecek.)
 * 
 * V99 Mandatory Kelime
 * 
 */

public class PaternDataTypeLevel_99V99 extends AbstractPattern{

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		AbstractPattern asp =new PaternDataTypeLevel_99V99();

	}

	public PaternDataTypeLevel_99V99() {
		super();
		//01
		...
		//99 Mandatory Sayi(değer verilmeyecek.)
		AbstractToken astSource6=new SayiToken<Integer>();
		astSource6.setSourceFieldName("length");
		patternTokenList.add(astSource6);
		
		//V99 Mandatory Kelime
		AbstractToken astSource7=new KelimeToken<String>();
		astSource7.setTekrarlayabilir("+");
		astSource7.addToShouldHaveList('V');
		astSource7.setSourceFieldName("decimalLength");
	...
	public void setTokenToElement(AbstractCommand matchedCommand,
		...
		//V99 Mandatory Kelime
			...
			matchedCommandAdd.setDecimalLength(currentTokenForMatch.getDeger().toString().length()-1); //V Harfini cikar
			matchedCommandAdd.getParameters().put("decimalLength2", matchedCommandAdd.getDecimalLength());
		}
