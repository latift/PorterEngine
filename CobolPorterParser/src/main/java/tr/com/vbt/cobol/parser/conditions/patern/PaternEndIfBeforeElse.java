...
import tr.com.vbt.cobol.parser.conditions.enders.ElementEndIfBeforeElse;
...
public class PaternEndIfBeforeElse extends AbstractPattern{
	...
	public AbstractCommand createElement(){
		ElementEndIfBeforeElse elementDisplay = new ElementEndIfBeforeElse(ReservedCobolKeywords.END_IF_BEFORE_ELSE,"PROCEDURE_DIVISION.*.END_IF_BEFORE_ELSE");
