...
/**
 * 000001		05  VLM-TODR                        PIC S9(12)V999	000001
 * 
 *
 *S9 Mandatory Kelime
 *( Mandatory
...
public class PaternDataTypeLevel_S9_Size_V99 extends AbstractPattern{

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		AbstractPattern asp =new PaternDataTypeLevel_S9_Size_V99();

	}

	public PaternDataTypeLevel_S9_Size_V99() {
		super();
		...
		astSource8.setTekrarlayabilir("+");
		astSource8.addToShouldHaveList('V');
	...
	public void setTokenToElement(AbstractCommand matchedCommand,
		...
		//V999 Mandatory Kelime (V ile basla)
			...
			matchedCommandAdd.setDecimalLength(currentTokenForMatch.getDeger().toString().length()-1);
