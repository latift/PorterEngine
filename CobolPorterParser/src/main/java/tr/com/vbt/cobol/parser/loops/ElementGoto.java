...
//
public class ElementGoto extends AbstractMultipleLinesCommand{
	
	private String paragraghName;
	
	private String runCount;
	
	public ElementGoto(AbstractToken baseToken,
			List<AbstractToken> tokenListesi, AbstractCommand parent) {
		super("ElementGoto","PROCEDURE_DIVISION.*.GOTO");
	}
	
	public ElementGoto(String elementName,String detailedCobolName) {
