...
/*
 * 000001		05 VAC-AMTFMT                   PIC 9(12)V999					000001
 * 
 * 9 Mandatory Sayi(değer verilecek.)
 * 
 * ( Mandatory
*	12 Mandatory Sayi
 * ) 
 * 
 * V999 Mandatory Kelime
 * 
 */

public class PaternDataTypeLevel_9_SizeV99 extends AbstractPattern{

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		AbstractPattern asp =new PaternDataTypeLevel_9_SizeV99();

	}

	public PaternDataTypeLevel_9_SizeV99() {
		super();
		//01
		...
		//9 Mandatory Sayi
		AbstractToken astSource4=new SayiToken<Double>(new Double(9),0,0,0);
		...
		// V999 Mandatory Kelime
		AbstractToken astSource8=new KelimeToken<String>();
		astSource8.setSourceFieldName("decimalLength");
	...
	public void setTokenToElement(AbstractCommand matchedCommand,
		...
		//V optional
			...
			matchedCommandAdd.setDecimalLength( currentTokenForMatch.getDeger().toString().length()-1); // V yi cikar
