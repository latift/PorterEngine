...
/*
000001		05 VAC-AMTFMT                   PIC S9(12)				000001
...
public class PaternDataTypeLevel_S9_Size extends AbstractPattern{

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		AbstractPattern asp =new PaternDataTypeLevel_S9_Size();

	}

	public PaternDataTypeLevel_S9_Size() {
		super();
		//01
