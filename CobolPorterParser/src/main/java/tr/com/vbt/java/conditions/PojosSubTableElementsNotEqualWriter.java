...
public class PojosSubTableElementsNotEqualWriter implements SimpleConditionWriter {
	...
	public void writeSimpleCondition(AbstractToken conditionLeft, AbstractToken conOperator,
		...
		JavaClassElement.javaCodeBuffer.append("FCU.subArrayAllElementsNotEquals(");
