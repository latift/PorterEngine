...
public abstract class AbstractPattern extends AbstractToken {
	...
	public AbstractPattern() {
		super("Pattern",0,0,TokenTipi.GenelTip,0);
	}


	public AbstractCommand getmatchedCommand(List<AbstractToken> tokenListesi, int offset, List<AbstractToken> currentPatern2){
